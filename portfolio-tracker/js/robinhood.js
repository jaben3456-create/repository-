...
function renderRobinhoodCard(state, { onDone } = {}) {
  ...
  const connectBtn = el('button', { class: 'btn', type: 'button', text: 'Step 1: Connect Robinhood' });
  const syncBtn = el('button', { class: 'btn', type: 'button', text: 'Step 2: Sync Robinhood holdings' });
